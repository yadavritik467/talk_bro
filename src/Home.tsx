  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="w-1/4 bg-white border-r border-gray-300">
        {/* <!-- Sidebar Header --> */}
        <header className="p-4 border-b border-gray-300 flex justify-between items-center dark:bg-gray-800 text-white">
          <h1 className="text-2xl font-semibold">Talk Bro 🥲</h1>
      ...
      <div className="flex-1">
        ...
        <div className="h-screen overflow-y-auto p-4 pb-36">
          ...
          <div className="flex justify-end mb-4 cursor-pointer">
            <div className="flex max-w-96 dark:bg-gray-800 text-white rounded-lg p-3 gap-3">
              <p>
